...
export class ConsultaComponent implements AfterViewInit {
    ...
    async ngAfterViewInit() {
        this.filtro.acessoRecente = this.activatedRoute.snapshot.data.acessoRecente || false;
    ...
    exportar() {
        this.colaboradorService.exportar(this.filtro.acessoRecente);
    }
}
